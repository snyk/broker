...
const tgzRequestCounter = new Counter({
  name: 'broker_tgz_request_count',
  help: 'A count of the number of times broker server requests a *.tgz file',
});
...
function incrementTgzRequestCounter() {
  tgzRequestCounter.inc(1);
}
