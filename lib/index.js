...
// TODO: Refactor this piece of code as it is quite un-readable
const app = (module.exports = {
  client: require('./client').startClient,
...
function main({ port, client, config = {} } = {}) {
  ...
  const localConfig = Object.assign({}, require('./config').config, config);
