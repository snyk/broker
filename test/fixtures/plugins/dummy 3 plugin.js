...
export class Plugin extends BrokerPlugin {
  ...
  isPluginActive() {
    if (this.brokerClientConfiguration.DISABLE_DUMMY_3_PLUGIN) {
  ...
  async startUp(connectionConfig) {
    ...
    connectionConfig['NEW_VAR_ADDED_TO_CONNECTION_FROM_DUMMY3_PLUGIN'] =
      'access-token-dummy3';
  }
  ...
  async preRequest(connectionConfiguration, postFilterPreparedRequest) {
    ...
    customizedRequest.body['NEW_VAR_ADDED_TO_CONNECTION_FROM_DUMMY3_PLUGIN'] =
      connectionConfiguration['NEW_VAR_ADDED_TO_CONNECTION_FROM_DUMMY3_PLUGIN'];
