...
describe('header relay', () => {
  ...
  it('swaps header values found in BROKER_VAR_SUB with application/x-www-form-urlencoded content-type', (done) => {
  ...
  it('swaps header values found in BROKER_VAR_SUB with json type', (done) => {
    expect.hasAssertions();
  ...
  it('does NOT swap header values found in BROKER_VAR_SUB with json type', (done) => {
    expect.hasAssertions();
  ...
  it('does NOT swap header values found in BROKER_VAR_SUB with application/x-www-form-urlencoded content-type', (done) => {
    expect.hasAssertions();
