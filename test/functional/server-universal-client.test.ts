...
process.env.SNYK_SOURCE_TYPES__testtype__brokerType = 'testtype';
...
process.env.SNYK_FILTER_RULES_PATHS__TESTTYPE = `${path.join(
  fixtures,
  'client',
...
describe('proxy requests originating from behind the broker server', () => {
  ...
  it('successfully broker POST', async () => {
    const response = await axiosClient.post(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-body`,
      { some: { example: 'json' } },
    );
  ...
  it('successfully broker GET', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-param/xyz`,
    );
  ...
  it('block request for non-whitelisted url', async () => {
    const response = await axiosClient.post(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/not-allowed`,
      {},
      {
        headers: {
          'content-type': 'application/json',
  ...
  it('allow request for valid url with valid body', async () => {
    const response = await axiosClient.post(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-body/filtered`,
      { proxy: { me: 'please' } },
      {
        headers: {
          'content-type': 'application/json',
  ...
  it('allow request for valid url with valid query param', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-query/filtered`,
      {
  ...
  it('bad broker id', async () => {
    const response = await axiosClient.post(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}XXX/echo-body`,
      {},
    );
  ...
  it('broker token is not included in headers from client to private', async () => {
    const response = await axiosClient.post(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-headers`,
      {},
    );
  ...
  it('querystring parameters are brokered', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-query`,
      {
        params: {
          shape: 'square',
          colour: 'yellow',
  ...
  it('approved URLs are blocked when escaped', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/long/nested%2Fpath%2Fto%2Ffile.ext`,
    );
  ...
  it('block request for url where client does not support required capability', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/client-not-capable`,
    );
  ...
  it('approved URLs are brokered when escaped as expected', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/long/nested/partially/encoded%2Fpath%2Fto%2Ffile.ext`,
    );
  ...
  it('auth header is replaced when url contains token', async () => {
    const response = await axiosClient.post(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-headers/github`,
      {},
      {
        headers: {
  ...
  it('auth header is is replaced when url contains basic auth', async () => {
    const response = await axiosClient.post(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-headers/bitbucket`,
      {},
    );
  ...
  it('successfully broker on endpoint that forwards requests with basic auth', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/basic-auth`,
    );
  ...
  it('ignores accept-encoding (gzip)', async () => {
    ...
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/echo-param/${paramRequiringCompression}`,
      {
        headers: {
  ...
  it('successfully stream data', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/test-blob/1`,
      {
        headers: {},
      },
    );
  ...
  it('successfully redirect POST request to git client', async () => {
    const response = await axiosClient.post(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/snykgit/echo-body`,
      { some: { example: 'json' } },
      {
        headers: {
          'content-type': 'application/json',
  ...
  it('successfully redirect exact bytes of POST body to git client', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/snykgit/echo-param/xyz`,
    );
  ...
  it('accept large responses', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/huge-file`,
    );
  ...
  it('allow request to git client with valid param', async () => {
    const response = await axiosClient.get(
      `http://localhost:${bs.port}/broker/universal/${process.env.SNYK_SOURCE_TYPES__testtype__publicId}/${brokerToken}/snykgit/echo-query`,
      {
        params: {
          proxyMe: 'please',
        },
